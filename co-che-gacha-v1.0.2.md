...
* Tại một thời điểm, trong `Endfield` sẽ có **2 nhân vật 6 sao đại diện gần nhất** (*?*) có thể được chiêu mộ từ một vòng quay giới hạn.
  * Ngoài ra, lúc này họ bị **gom chung** với các **nhân vật 6 sao vĩnh viễn** (*là các nhân vật 6 sao **luôn tồn tại trong các vòng quay giới hạn***) nên không còn được hưởng các [cơ chế đặc biệt](co-che-gacha-v1.0.2.md#1-2-cac-co-che-dac-biet-) nữa.
